...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    site_label = (os.environ.get("WEBSITE_BUTTON_LABEL") or "Сайт VibeWork").strip() or "Сайт"
    ...
    intro = (
        ...
        "• <b>Сайт</b> — полная веб-версия VibeWork: диагностика, план, симулятор дня. Кнопка ниже.\n"
