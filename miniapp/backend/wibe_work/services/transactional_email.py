...
async def send_transactional_email(
    ...
    """
    Сначала SMTP (если задан в .env). Если SMTP недоступен — Unisender (Web API / Go), затем Mailgun.
    """
    if smtp_configured():
    ...
    return (
        False,
        "Почта не настроена: задайте SMTP (EMAIL_SMTP_* + EMAIL_FROM) или Unisender (UNISENDER_API_KEY + UNISENDER_LIST_ID) или Mailgun.",
    )
